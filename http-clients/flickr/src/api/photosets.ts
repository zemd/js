...
export const DeletePhotosetQuerySchema = z.object({
  photoset_id: z
    .string()
    .describe("The id of the photoset to delete. It must be owned by the calling user."),
});
...
export const EditPhotosPhotosetQuerySchema = z.object({
  photoset_id: z
    .string()
    .describe("The id of the photoset to modify. The photoset must belong to the calling user."),
  primary_photo_id: z
    .string()
    .describe(
...
export interface RemovePhotosPhotosetQuery extends z.infer<
  typeof RemovePhotosPhotosetQuerySchema
> {}
...
export const ReorderPhotosPhotosetQuerySchema = z.object({
  photoset_id: z
    .string()
    .describe("The id of the photoset to reorder. The photoset must belong to the calling user."),
  photo_ids: z
    .string()
    .describe(
...
export interface ReorderPhotosPhotosetQuery extends z.infer<
  typeof ReorderPhotosPhotosetQuerySchema
> {}
...
export interface SetPrimaryPhotoPhotosetQuery extends z.infer<
  typeof SetPrimaryPhotoPhotosetQuerySchema
> {}
