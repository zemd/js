...
const renderCombinedReleaseBody = ({ published, paths, notes }) => {
	const out = [];
...
const releasePublishedPackages = async ({ api, sha, published, workspace, now = /* @__PURE__ */ new Date() }) => {
...
const githubReleases = {
	...
	run: async (argv) => {
		...
		if (!summaryPath || !workspacePath) throw new Error("usage: github-releases <publish-summary.json> <workspace-list.json>");
